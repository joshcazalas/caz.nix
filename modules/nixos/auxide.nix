...
in
{
  ...
  config = lib.mkIf cfg.enable {
    assertions = [
      {
        # Keep this assertion local even though container-runtime.nix normally
        # enables Docker for the provider. It turns an incomplete import or
        # future runtime-policy regression into an evaluation error.
        assertion =
        ...
        message = ''
          ...
          runtime is enabled. Import the shared container runtime, or set
          services.auxide.poTokenProvider.enable = false and point
